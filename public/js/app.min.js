...
u["delete"](t._id).then(function(t){return a.success("Usuário excluído com sucesso!"),e.users.splice(r,1),i.hide()})["catch"](function(e){return a.error("Erro ao excluir usuário. Por favor, tente novamente."),i.hide()}))}}]);
